...
func Login(ctx *Context, c web.C, r *http.Request) *Response {
	session := GetSession(c)

	content, err := ctx.Parse("login", Data{
...
func LoginPost(ctx *Context, c web.C, r *http.Request) *Response {
